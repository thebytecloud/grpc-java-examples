...
public final class GreetingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.thebytecloud.greeting.HelloRequest,
      com.thebytecloud.greeting.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sayHello",
      requestType = com.thebytecloud.greeting.HelloRequest.class,
      responseType = com.thebytecloud.greeting.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.thebytecloud.greeting.HelloRequest,
      com.thebytecloud.greeting.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.thebytecloud.greeting.HelloRequest, com.thebytecloud.greeting.HelloResponse> getSayHelloMethod;
      ...
      synchronized (GreetingServiceGrpc.class) {
        if ((getSayHelloMethod = GreetingServiceGrpc.getSayHelloMethod) == null) {
          GreetingServiceGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<com.thebytecloud.greeting.HelloRequest, com.thebytecloud.greeting.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "greeting.GreetingService", "sayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.thebytecloud.greeting.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.thebytecloud.greeting.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.thebytecloud.greeting.HelloRequest request,
        io.grpc.stub.StreamObserver<com.thebytecloud.greeting.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.thebytecloud.greeting.HelloRequest,
                com.thebytecloud.greeting.HelloResponse>(
  ...
  public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractStub<GreetingServiceBlockingStub> {
    ...
    /**
     */
    public com.thebytecloud.greeting.HelloResponse sayHello(com.thebytecloud.greeting.HelloRequest request) {
  ...
  public static final class GreetingServiceFutureStub extends io.grpc.stub.AbstractStub<GreetingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.thebytecloud.greeting.HelloResponse> sayHello(
        com.thebytecloud.greeting.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.thebytecloud.greeting.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.thebytecloud.greeting.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreetingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.thebytecloud.greeting.Greeting.getDescriptor();
    }
